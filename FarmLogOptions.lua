...
-- Helper function to create an options category
local function CreateOptionsCategory(reference, title)
    local category = Settings.RegisterCanvasLayoutCategory(reference, title)
